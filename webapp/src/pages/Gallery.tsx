      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
          <div>
            ...
            <h1 className="text-text-primary" style={{ fontSize: 28, fontWeight: 700, marginBottom: 6 }}>Components</h1>
            <p style={{ fontSize: 14, color: 'var(--text-secondary)', maxWidth: 600, lineHeight: 1.5 }}>
              500 UI components generated by Qwen3.6-27B, critiqued and improved by GPT-5.4.
              Each component is shown with its original prompt, design critique, and expert-improved version.
              Click any component to see the full before/after.
            </p>
            <div style={{ marginTop: 12, fontSize: 13, color: 'var(--text-muted)', display: 'flex', gap: 16, alignItems: 'center' }}>
              <span>{total} components</span>
              <span>·</span>
              <span>5 temperature variants per prompt</span>
              <span>·</span>
              <span>Avg score 8.6/9</span>
            </div>
          </div>
