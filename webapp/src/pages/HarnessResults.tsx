    ...
    <div className="page-container" style={{ paddingTop: 32, paddingBottom: 64 }}>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p className="text-text-secondary" style={{ fontSize: 15, maxWidth: 640, lineHeight: 1.7, marginBottom: 16 }}>
          The Pi Harness V4.2C is a split pipeline that generates raw HTML from{' '}
          ...
          , then runs a 21-item production checklist to identify missing quality items (hover states, focus-visible, SVG icons, responsive breakpoints, ARIA accessibility). Missing items are sent as a YAML work order to a separate polish session with the original prompt for factual verification. The model signs off on each fix applied. The results show consistent quality gains — production-ready interactive states, inline SVG icons, proper typography hierarchy, and prompt-faithful color and layout choices — achieved in ~5.5 minutes per component with 100% completion rate.
        </p>
