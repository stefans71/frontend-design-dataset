...
export default function PiHarnessComponentPage() {
  ...
  const lastPage = sessionStorage.getItem('pi-harness-gallery-page') || '0'
  const backTo = `/pi-harness/components?page=${lastPage}`
    ...
    return (
      <div className="page-container" style={{ paddingTop: 32, paddingBottom: 48 }}>
        <div className="flex flex-col items-center justify-center py-20 border border-dashed border-border rounded-lg">
          ...
          <Link to="/pi-harness/components" className="mt-3 text-sm text-text-secondary no-underline hover:text-text-primary transition-colors duration-150">
            ← Back to Gallery
          </Link>
        </div>
      </div>
    ...
    <div className="page-container" style={{ paddingTop: 32, paddingBottom: 48 }}>
      <div className="flex items-center gap-3 mb-6">
        <Link
          ...
          aria-label="Back to Pi Harness Training Data"
        >
