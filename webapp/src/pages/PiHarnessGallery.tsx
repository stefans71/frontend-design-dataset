      ...
      <div style={{ marginBottom: 32 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
          <div>
            ...
            <h1 className="text-text-primary" style={{ fontSize: 32, fontWeight: 800, lineHeight: 1.2, marginBottom: 4 }}>Training Data</h1>
            ...
            <p style={{ fontSize: 14, color: 'var(--text-secondary)', maxWidth: 580, lineHeight: 1.6, marginBottom: 12 }}>
              Side-by-side comparison of the original Qwen output, GPT-5.4 improved version,
              and Pi Harness pipeline results for the same prompts.
            </p>
          </div>
